# Pokémon Ultra Moon plugin

Read-only 3GX PK7 memory bridge for the **North American Pokémon Ultra Moon** build used by 3DSShinyHunter.

- Output: `3DSShinyHunter-UltraMoon.3gx`
- North American title ID / install folder: `00040000001B5100`
- UDP port: `4951`
